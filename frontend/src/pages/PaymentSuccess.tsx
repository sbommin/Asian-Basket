...
const PaymentSuccess = () => {
  ...
  return (
    // ✅ No flex-col — plain block so Header doesn't interfere
    <div className="min-h-screen bg-gray-50">
      <Header />

      {/* ✅ pt matches your app's other pages (same as index/checkout) */}
      <main className="pt-[200px] md:pt-[220px] pb-20 px-4 min-h-screen">

        {/* ✅ Card is top-aligned inside padded page, not viewport-centered */}
        <div className="max-w-md mx-auto bg-white rounded-2xl shadow-md p-8 flex flex-col items-center text-center">
          ...
          {status === "SUCCESS" && (
            <>
              ...
              {orderId && (
                <div className="bg-green-50 border border-green-100 rounded-lg px-4 py-3 w-full mb-6">
                  <p className="text-xs text-green-600 font-medium mb-1">Order ID</p>
                  <p className="text-sm font-mono font-semibold text-green-800 break-all">
                    {orderId}
                  </p>
                </div>
          ...
          {status === "PENDING" && (
            <>
              ...
              <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                Your payment is still being processed. If money has been
                deducted from your account, your order will be confirmed
                shortly. You'll receive a confirmation email.
              </p>
              {orderId && (
                <div className="bg-yellow-50 border border-yellow-100 rounded-lg px-4 py-3 w-full mb-6">
          ...
          {status === "FAILED" && (
            <>
              ...
              {orderId ? (
                <div className="bg-red-50 border border-red-100 rounded-lg px-4 py-3 w-full mb-6">
                  <p className="text-xs text-red-500 font-medium mb-1">Order ID</p>
                  <p className="text-sm font-mono font-semibold text-red-800 break-all">
                    {orderId}
                  </p>
                </div>
